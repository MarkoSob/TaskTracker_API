...
namespace TaskTracker_DAL.Migrations
{
    ...
    [Migration("20230115005557_AddedCreateDateFieldForTask")]
    partial class AddedCreateDateFieldForTask
    {
            ...
            modelBuilder.Entity("TaskTracker_DAL.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("4e506bed-0876-4e8b-a4ca-15d6167c5c97"),
                            Title = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("TaskTracker_DAL.Entities.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = new Guid("4e506bed-0876-4e8b-a4ca-15d6167c5c97")
                        });
                });
